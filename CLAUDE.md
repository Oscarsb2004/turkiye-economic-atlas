...
```bash
python run.py            # the atlas in a browser, on a port it prints before it opens
python run.py --pipeline # every stage, the tests, verification, and a summary of the three
