...
const tr = {
  ...
  nightlightsRule: "Son beş yılın her ayı, ondan öncesinin her yılı için katmanın yayımladığı son gece",
...
const en: Strings = {
  ...
  nightlightsRule: "The last night the layer publishes in each month of the past five years, and in each year before them",
