...
const tr = {
  ...
  groupEconomic: "Ekonomi",
  groupElections: "Seçimler",
  ...
  railNoShading: "Bu katman hat çizer; il başına renk üretmez.",
  ...
  nightlightsRule: "Her yıl için katmanın yayımladığı son gece seçilmiştir",
  ...
  basemapNote: "Natural Earth'ün yerleşim adları ve ana yolları; yol ağı ayrıntılı bir karayolu haritası değildir.",
  time: "Zaman",
...
const en: Strings = {
  ...
  railNoShading: "This layer draws lines; it shades no provinces.",
  ...
  nightlightsRule: "The last night the layer publishes in each year",
  ...
  basemapNote: "Natural Earth's settlement names and major roads; the road network is not a detailed highway map.",
  time: "Time",
